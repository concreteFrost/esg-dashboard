...
$('#swap-cards-btn').click(() => {
  ...
  draggable = !draggable;
  if (draggable) {
    $('#sort-cards-1').sortable();
    $('#sort-cards-2').sortable();
    ...
    $('#sort-cards-1').sortable('destroy');
    $('#sort-cards-2').sortable('destroy');
...
$('#carousel-animation').on('change',()=>{
  if ($('#carousel-animation').is(':checked')) {
    $('#cardCarouselControls').carousel({ interval: 4000});
  } 
  else if (!$('#carousel-animation').is(':checked')) {
    $('#cardCarouselControls').carousel({ interval: false });
  }
})
