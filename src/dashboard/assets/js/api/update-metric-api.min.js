    ...
    success: function (data) {
      $.ajax({
        ...
        success: function (d2) {
          ...
          $('#update-metric-last-review-data').val(d2.LastReviewDate.split('T')[0])
          $('#update-metric-next-review-data').val(d2.NextReviewDate.split('T')[0])
    ...
    success: function (data) {
      $.ajax({
        ...
        data: {
          ...
          "LastReviewDate": $('#update-metric-last-review-data').val(),
          "NextReviewDate": $('#update-metric-next-review-data').val(),
