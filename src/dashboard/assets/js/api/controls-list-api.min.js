...
function getControls(data){
  $.ajax({
    url: 'https://cors-anywhere.herokuapp.com' + 'https://europe.grc1.com/iGRC/api/Control/Get',
    async: true,
    crossDomain: true,
    method: 'GET',
    data: {
    ...
    success: function (data2) {
      ...
      controlsArr.forEach((c) => {
        ...
        <td><a href="/dashboard/company/individual-c.html" onclick="redirectToRisk(this)" data-id=${
          c.ControlId
        }> ${c.ControlName} </a></td>
