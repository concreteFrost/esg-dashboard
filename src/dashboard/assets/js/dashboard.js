...
function initMap() {
  ...
  var contentString =
    '<div class="info-window-content"><h2>esg:one Dashboard</h2>' +
    '<p>Visualising ESG data for brands.</p></div>';
...
var BarStackedChart = (function () {
  // Variables
  var $chart = $('#chart-risk-comparison');

  // Methods
  function init($this) {
    // Return a random number to generate datasets
    ...
    var map = $this.data('map'),
      ...
      options = {
        ...
        markers: [
          ...
          {
            latLng: [55.378052, -3.435973],
            name: 'United Kingdom',
          },
          {
            latLng: [20.593683, 78.962883],
            name: 'India',
          },
        ],
        series: {
          regions: [
            {
              values: series,
              scale: [colors.gray[400], colors.theme.primary],
              normalizeFunction: 'polynomial',
            },
          ],
        },
