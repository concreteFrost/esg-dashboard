...
*/
d3.json("/dashboard/assets/data/treemap.json",function(v){function w(b){b.x=b.y=0;b.x1=d;b.y1=500;b.depth=0}function p(b){return(b._children=b.children)?b.value=b.children.reduce(function(a,b){return a+p(b)},0):b.value}function q(b){b._children&&b._children.forEach(function(a){a.x0=b.x0+a.x0*b.x1;a.y0=b.y0+a.y0*b.y1;a.x1*=b.x1;a.y1*=b.y1;a.parent=b;q(a)})}function r(b){function a(a){if(!m&&a){m=!0;var b=r(a),l=d.transition().duration(750),e=b.transition().duration(750);c.domain([a.x0,a.x0+a.x1]);
