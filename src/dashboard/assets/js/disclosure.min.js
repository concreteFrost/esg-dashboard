...
*/
var DatatableSasb=function(){function b(a){a.on("init.dt",function(){$(".dt-buttons .btn").removeClass("btn-secondary").addClass("btn-sm btn-default")}).DataTable({stateSave:!0,stateDuration:86400,pageLength:20,dom:"Bfrt",buttons:[{extend:"collection",text:"Show columns",columns:".colhead",className:"btn-outline-primary",buttons:["columnsVisibility"],visibility:!0},"copy",{extend:"print",exportOptions:{columns:":visible"}},{extend:"pdf",pageSize:"A4",orientation:"landscape",exportOptions:{columns:":visible"}},
"excel"]})}var a=$("#disclosure-datatable");a.length&&b(a)}();
